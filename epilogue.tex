...
\chapter{Alert Dependency Plots}
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=.8\textwidth]{WGAN_22}
		\caption{
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=.8\textwidth]{WGAN_100}
		\caption{
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=.8\textwidth]{WGAN_143}
		\caption{
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=.8\textwidth]{GPMI_22}
		\caption{
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=.8\textwidth]{GPMI_100}
		\caption{
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=.8\textwidth]{GPMI_143}
		\caption{
