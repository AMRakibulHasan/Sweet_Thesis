...
\title{Synthesizing Cyber Intrusion Alerts using Generative Adversarial Networks}
\date{April 2019}

% Advisor details
\advisor{Professor}{Shanchieh}{Yang}
\committee{Assistant Professor}{Raymond}{Ptucha}{}
\committee{Associate Professor}{Sonia}{Lopez-Alarcon}{}
