...
Though there is no direct weighting applied to the results of each feature combination the importance of each feature generated does play a role in how realistic the alert seemed. For example, generating realistic alert signatures provides directly actionable information regarding what types of attacks or vulnerabilities are targeted on the given source. However, this information becomes much more useful when paired with a realistic destination service. Later on, the results will show that the models presented by this work are capable of learning these useful feature value combinations.
...
%		\begin{tabular}{ccc}
%			\multicolumn{1}{c|}{\textbf{M}} & \multicolumn{1}{l|}{\textbf{WGAN-GP}} & \multicolumn{1}{l}{\textbf{WGAN-GPMI}} \\ \hline
%			\multicolumn{1}{c|}{\multirow{4}{*}{\textbf{1}}} & \multicolumn{1}{c|}{5} & \multicolumn{1}{c}{1} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{1} & \multicolumn{1}{c}{2} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{0} & \multicolumn{1}{c}{0} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{10} & \multicolumn{1}{c}{1} \\ \hline
%			
%			\multicolumn{1}{c|}{\multirow{6}{*}{\textbf{2}}} & \multicolumn{1}{c|}{17} & \multicolumn{1}{c}{2} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{6} & \multicolumn{1}{c}{2}  \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{11} & \multicolumn{1}{c}{4} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{13} & \multicolumn{1}{c}{1} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{7} & \multicolumn{1}{c}{6} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{10} & \multicolumn{1}{c}{3} \\ \hline
%			
%			
%			\multicolumn{1}{c|}{\multirow{4}{*}{\textbf{3}}} & \multicolumn{1}{c|}{14} & \multicolumn{1}{c}{9} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{20} & \multicolumn{1}{c}{5} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{18} & \multicolumn{1}{c}{5} \\
%			\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{16} & \multicolumn{1}{c}{6} \\ \hline
%			
%			\multicolumn{1}{c|}{\textbf{4}} & \multicolumn{1}{c|}{21} & \multicolumn{1}{c}{10} \\ \hline
%			\hline
%			
%			\multicolumn{1}{l|}{\textbf{\# Alerts}} & \multicolumn{1}{c|}{3388} & \multicolumn{1}{l}{} \\
%			\multicolumn{1}{l|}{\textbf{\# Unique Modes}} & \multicolumn{1}{c|}{32} & \multicolumn{1}{l}{} \\
%			\multicolumn{1}{l|}{\textbf{\% Modes Dropped}} & \multicolumn{1}{c|}{0.6563} & \multicolumn{1}{c}{0.3125} 
%		\end{tabular}
%\end{table}
